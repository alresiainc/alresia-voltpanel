...
// TestRealDetectInstalled exercises the real nvmInstaller against whatever
// Node/nvm setup exists on the machine running the test. It never installs
// or removes anything -- detection is read-only -- but per the plan
